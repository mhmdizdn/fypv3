  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center min-h-[70vh] bg-[#fafafa] relative overflow-hidden pt-20">
        ...
        <form className="w-full max-w-2xl flex flex-col gap-4 bg-white rounded-xl shadow-lg p-6 mb-10" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            <div className="flex flex-1 gap-2">
              <textarea
                ...
                className="flex-1 px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#7919e6] text-lg resize-none"
                value={address}
