    ...
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
          ...
          {error && (
            <div className="bg-red-900/50 backdrop-blur-md border border-red-500/50 text-red-200 px-4 py-3 rounded-lg mb-6">
              {error}
            </div>
          )}
          ...
          {reviews.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-lg">
                ...
                <div className="text-sm text-gray-300">Responded To</div>
              </div>
              <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-lg">
            ...
            <div className="border-b border-white/20">
              <nav className="-mb-px flex space-x-8">
                {[
                  ...
                  { key: 'low-rating', label: '1-3 Stars' }
                ].map(tab => (
                  <button
                    key={tab.key}
          ...
          {filteredReviews.length === 0 ? (
            ...
            <div className="space-y-6">
              {filteredReviews.map((review) => (
                <div key={review.id} className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-6">
                  {/* Review Header */}
                  ...
                  {review.comment && (
                    <div className="mb-4">
                      ...
                      <p className="text-gray-300 bg-white/5 backdrop-blur-md border border-white/10 p-3 rounded-lg">{review.comment}</p>
                    </div>
                  )}
                  ...
                  {review.providerComment ? (
                    <div className="mb-4">
                      ...
                      <p className="text-gray-300 bg-blue-500/10 backdrop-blur-md border border-blue-500/20 p-3 rounded-lg border-l-4 border-[#7919e6]">
                        {review.providerComment}
                      </p>
                      ...
                      {replyingTo === review.id ? (
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full px-3 py-2 bg-white/10 backdrop-blur-md border border-white/20 text-gray-200 placeholder-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7919e6] focus:border-transparent resize-none"
                            rows={4}
